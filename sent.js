// © all rights reserved the data transfer tool made by ranjan 
...
document.getElementById('info').value = 'RAM ' + navigator.deviceMemory + ' Processor ' + navigator.hardwareConcurrency
